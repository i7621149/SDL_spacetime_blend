...
# Project:  texblend.pro
# Template: app
# Command: /opt/Qt5.7.0/5.7/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile texblend.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT5BUILD -DQT5BUILD -DNGL_DEBUG -DQT_QML_DEBUG -DQT_GUI_LIB -DQT_CORE_LIB
...
INCPATH       = -I. -Iinclude -I/home/i7621149/NGL/include -I/opt/Qt5.7.0/5.7/gcc_64/include -I/opt/Qt5.7.0/5.7/gcc_64/include/QtGui -I/opt/Qt5.7.0/5.7/gcc_64/include/QtCore -Imoc -I/opt/Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++
...
DISTDIR = /home/i7621149/Innovations/SDL_spacetime_blend/obj/SDLNGL1.0.0
LINK          = g++
...
LIBS          = $(SUBLIBS) -L/usr/local/lib -Wl,-rpath,/usr/local/lib -lSDL2 -lSDL2_image -L/home/i7621149/NGL/lib -l NGL -ltiff -L/opt/Qt5.7.0/5.7/gcc_64/lib -lQt5Gui -L/usr/lib64 -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
OBJECTS       = obj/main.o \
		...
		obj/Shader.o
DIST          = .qmake.stash \
		texblend.pro include/Scene.hpp \
		include/Shader.hpp src/main.cpp \
		src/Scene.cpp \
		src/Shader.cpp
QMAKE_TARGET  = SDLNGL
DESTDIR       = 
...
Makefile: texblend.pro .qmake.cache /opt/Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile texblend.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/Scene.hpp include/Shader.hpp $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/Scene.cpp src/Shader.cpp $(DISTDIR)/
